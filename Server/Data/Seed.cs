...
public static class Seed
{
    ...
    public static async void SeedAsync(this IServiceProvider serviceProvider)
    {
        ...
        using var context = scope.ServiceProvider.GetRequiredService<RotRutContext>();
    ...
    private static void DoSeedAccounts(RotRutContext context)
    {
    ...
    private static void DoSeedVerifications(RotRutContext context)
    {
        InsertMoney(context);
    ...
    private static void InsertMoney(RotRutContext context)
    {
    ...
    private static void YouSendAnInvoiceToCustomer(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
    ...
    private static void TheCustomerPaysTheInvoice(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
    ...
    private static void YouReceiveAInvoice(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
    ...
    private static void YouPayForTheInvoice(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
    ...
    private static void YouWithdrawMoneyAsSalary(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
    ...
    private static void YouTransferFromPlusGiroToCorporateAccount(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
    ...
    private static void YouTransferFromTaxAccountToCorporateAccount(RotRutContext context)
    {
        context.Verifications.AddRange(
            new Verification
            {
